    ...
    <div className="min-h-screen bg-[#1a1a1a] relative flex flex-col overflow-x-hidden" style={{ fontFamily: "'Aileron', sans-serif" }}>
      ...
      <section className="relative w-full h-[100svh] bg-gradient-to-b from-black/80 via-black/60 to-transparent flex flex-col items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col items-center px-6">
          ...
          <p
            className="font-light italic text-white/80 text-sm md:text-base leading-relaxed tracking-wide text-center mt-6 max-w-xs md:max-w-sm opacity-0 animate-fade-in"
          ...
          >
            ...
            se vuelve a la vida.
            <span className="block mt-2 text-[11px] md:text-xs tracking-[0.3em] uppercase text-white/50 not-italic">
              Proverbios 27:9
            </span>
          </p>
        </div>
