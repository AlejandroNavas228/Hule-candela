      ...
      <div className="relative w-full max-w-lg bg-[#1a1a1a] border border-gray-700 rounded-3xl p-8 shadow-2xl animate-fade-in">
        ...
        <form onSubmit={onSubmit} className="space-y-4">
          ...
          <div className="pt-4 flex flex-col-reverse md:flex-row gap-3">
            <button type="button" onClick={onCerrar} className="w-full md:w-1/3 bg-transparent border border-gray-600 md:border-transparent text-gray-400 hover:text-white font-bold py-3 rounded-xl transition-colors text-sm">CANCELAR</button>
